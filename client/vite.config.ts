    ...
    configureServer(server: any) {
      server.middlewares.use((req: any, res: any, next: any) => {
        ...
        res.setHeader(
          ...
          `connect-src 'self' ws://localhost:5173 ws://127.0.0.1:5000 https://api.themoviedb.org https://image.tmdb.org https://www.paypal.com https://www.sandbox.paypal.com https://fonts.googleapis.com https://i.pinimg.com https://fonts.gstatic.com https://www.google-analytics.com https://www.googletagmanager.com https://hilltopads.net https://*.hilltopads.net https://selfishzone.com https://*.selfishzone.com; ` +
          ...
          `media-src 'self' blob: https: https://hilltopads.net https://*.hilltopads.net https://selfishzone.com https://*.selfishzone.com; ` +
          `worker-src 'self' blob:; ` +
          `child-src 'self' blob: https://zupload.co https://zupload.cc https://zupload.io https://*.zupload.co https://*.zupload.cc https://*.zupload.io https://hilltopads.net https://*.hilltopads.net https://selfishzone.com https://*.selfishzone.com;`
        );
        next();
      });
    }
